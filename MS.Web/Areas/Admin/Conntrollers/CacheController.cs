...
namespace MS.Web.Areas.Admin.Conntrollers
{
    ...
    public class CacheController : AdminBaseController
    {
        ...
        [HttpPost]
        public ActionResult ClearCache(FormCollection FC)
        {
            try
            {
                ...
                if (cardNo != null )
                {
                    tr.com.migros.magazaiphone.CacheService cserv = new tr.com.migros.magazaiphone.CacheService();

                    cserv.AuthenticationHeaderValue = new tr.com.migros.magazaiphone.AuthenticationHeader();
                    cserv.AuthenticationHeaderValue.ServiceApiKey = "UetkG2agLx8GJjVBkZQb7XYok70+1w7iPsy23HPGuGY=";
                    cserv.AuthenticationHeaderValue.ServiceSecretKey =  "2xMcbZ9mBX0wCmRaIChb6SpoEDNYdS2NHTmqZX+5wlZtLaZHqNpYalPwPZhv6fmvNSaHkMYdot6D1T0A6W0NIQ==";

                    tr.com.migros.magazaiphone.Result res = cserv.ClearCacheForCardNumber(cardNo);
                    if (res.HasError == false)
                    {
                        ShowMessageBox(MessageType.Success, "Cache temizlendi!!", false);
            ...
            {
                ShowMessageBox(MessageType.Warning, ex.Message, false);
        ...
        public ActionResult SendTextNotifiactionWithDeviceToken(FormCollection FC)
        {
            //try
            //{
            ...
            if (FC["TextBodyWDeviceToken"] != null)
            {
                message = FC["TextBodyWDeviceToken"];

                String dtNotification = FC["dtNotificationWDeviceToken"];
                ...
                if (Request.Files.Count > 0)
                {
                    ...
                    if (file != null && file.ContentLength > 0)
                    {
                        int ix = Global.Context.spCMSNotifMaster(message, s, dtNot, "0", "0", "CihazNo");
                        Global.Context.spCMSClearNotifQueue(s);
                        ...
                        DataTable dt = new DataTable();
                        dt.Columns.AddRange(new DataColumn[2] { 
                                new DataColumn("DeviceToken", typeof(string)),
                                new DataColumn("NotificationKey",typeof(string)) });
                        ...
                        using (SqlConnection con = new SqlConnection(conString))
                        {
                            ...
                            {
                                //Set the database table name.
                                sqlBulkCopy.DestinationTableName = "TblCMSDeviceTokenTmp";
                                sqlBulkCopy.BulkCopyTimeout = 90;
        ...
        //[HttpGet]
        //public ActionResult reportx(string notifKey)
        //{
        ...
        //}
         ...
         [HttpGet]
        public void report(string notifKey)
        {
            var notifreports = Global.Context.NotifReport(notifKey).ToList();
            ...
            ///PartialView("CardNumberReport", notifreports);
        }
