(function ($) {
    function SallaKazanIndex() {
        var $this = this, formAddEditSallaKazan, formDelete;
        ...
        function initGridControlsWithEvents() {
            ...
            $('.switchBox').each(function (index, element) {
                ...
                .on('switch-change', function () {
                    ...
                    $.post(siteAdminDomain + 'admin/SallaKazan/SallaKazanActive', { id: this.value }, function (result) {
                        if (!result.isSuccess) {
            ...
            $(".deletePhoto").on("click", function () {
                if (confirm("Photo will be deleted permanently, please confirm?")) {
                    ...
                    $.ajax({
                        ...
                        data: { folder: "SallaKazanImage", filename: $(this).attr("rel") },
        ...
        function initializeModalWithForm() {
            $("#modal-create-edit-SallaKazan").on('loaded.bs.modal', function (e) {
                formAddEditSallaKazan = new Global.FormHelper($(this).find("form"), { updateTargetId: "validation-summary" });
